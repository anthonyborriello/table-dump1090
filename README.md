...
4. In the `radar_table.php` file, customize the URL in the `$response` variable to match your Dump1090 server setup (e.g., `$response = file_get_contents('http://raspberrypi:8080/data/aircraft.json');`).
